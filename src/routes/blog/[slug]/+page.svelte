    ...
    <article
      ...
      <div class="mt-12 border-t border-border-subtle pt-8 select-none">
        ...
        <div class="flex flex-wrap items-center justify-between gap-3">
          ...
          {#each [{ href: `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(page.url.href)}`, icon: 'bi-linkedin', label: 'Share on LinkedIn (opens in a new tab)', text: 'LinkedIn' }, { href: `https://twitter.com/intent/tweet?url=${encodeURIComponent(page.url.href)}&text=${encodeURIComponent(post.title)}`, icon: 'bi-twitter-x', label: 'Share on X (opens in a new tab)', text: 'X' }, { href: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(page.url.href)}`, icon: 'bi-facebook', label: 'Share on Facebook (opens in a new tab)', text: 'Facebook' }, { href: `https://www.threads.net/intent/post?text=${encodeURIComponent(post.title + ' ' + page.url.href)}`, icon: 'bi-threads', label: 'Share on Threads (opens in a new tab)', text: 'Threads' }, { href: `mailto:?subject=${encodeURIComponent(post.title)}&body=${encodeURIComponent(page.url.href)}`, icon: 'bi-envelope', label: 'Share via email', text: 'Email' }] as item (item.text)}
            <a
              href={item.href}
...
<Dialog
  ...
  <div class="grid grid-cols-2 gap-2 text-left">
    ...
    {#each [{ href: `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(page.url.href)}`, icon: 'bi-linkedin', text: 'LinkedIn' }, { href: `https://twitter.com/intent/tweet?url=${encodeURIComponent(page.url.href)}&text=${encodeURIComponent(post.title)}`, icon: 'bi-twitter-x', text: 'X' }, { href: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(page.url.href)}`, icon: 'bi-facebook', text: 'Facebook' }, { href: `https://www.threads.net/intent/post?text=${encodeURIComponent(post.title + ' ' + page.url.href)}`, icon: 'bi-threads', text: 'Threads' }, { href: `mailto:?subject=${encodeURIComponent(post.title)}&body=${encodeURIComponent(page.url.href)}`, icon: 'bi-envelope', text: 'Email' }] as item (item.text)}
      <a
        href={item.href}
        target={item.href.startsWith('mailto') ? undefined : '_blank'}
        rel="noopener noreferrer"
