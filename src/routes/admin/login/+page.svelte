    ...
    <div class="boxed-list p-6 bg-zinc-950/1">
      ...
      <form
        ...
        <div class="flex flex-col gap-1.5">
          <label
            for="login-email"
            class="text-xs font-bold text-adwaita-subtitle">Email Address</label>
          <input
            type="email"
            id="login-email"
            required
        ...
        <div class="flex flex-col gap-1.5">
          <label
            for="login-pass"
            class="text-xs font-bold text-adwaita-subtitle">Password</label>
          <input
            type="password"
            id="login-pass"
            required
        ...
        <button
          ...
          {:else}
            <i
              class="bi bi-box-arrow-in-right text-sm"
              aria-hidden="true"></i>
            Sign In
          {/if}
        </button>
